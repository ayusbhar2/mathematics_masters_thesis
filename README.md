This repository contains my MA thesis. The file named `Thesis.pdf` contains the full thesis. Files named `Presntation*` comtain a condensed version of the material that I presented in my thesis defense.
